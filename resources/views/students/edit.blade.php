                        ...
                        <div class="row card-body col-12">
                            <div class="form-group col-12">
                                ...
                                <input type="text" class="form-control g-2" id="fname" name="fname"
                                    placeholder="Enter your Firstname" require value="{{ $students->fname}}">
                            </div>
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" class="form-control" id="lname" name="lname"
                                    placeholder="Enter your Last Name" value="{{ $students->lname}}">
                            </div>
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" class="form-control" id="midname" name="midname"
                                    placeholder="Enter your Middle Name" value="{{ $students->midname}}">
                            </div>
